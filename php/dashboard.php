...
?>
    ...
    <body>
        ...
        $mapperProdukt = new menuMapper();
        $produktet = $mapperMenu->getAllProducts();
        ...
        <div class='btn_dashboard_container'> 
            ...
            <button id="btn-news" class="btn">Events</button>
        </div>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php echo $mesazhet['name']; ?></td>
                            <td><?php echo $mesazhet['last name']; ?></td>
            ...
            <table class="content-table-users">
                ...
                <tbody>
                    ...
                    foreach ($menus as $menu) { ?>
                        <tr>
                            <td><?php echo $menu['id_produkti']; ?></td>
